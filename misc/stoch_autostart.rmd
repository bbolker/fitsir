...
```{r hist1, message = FALSE, fig.width = 15, fig.height = 5}
...
I got rid of the axis labels because it was getting too messy...

```{r plot_badfits, echo = FALSE, fig.width = 18, fig.height = 12}
...
ggplot(mL.fit) + geom_line(aes(t, value, col = L2, linetype = variable, group = interaction(L2,variable))) +
    geom_line(data = mL.start, aes(t, value)) +
    geom_point(data = mL.data, aes(t, value), size = 0.4, alpha = 0.4) + 
