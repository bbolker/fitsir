...
load("stochsim_5.rda")  ## main results
...
```{r plotspline,fig.width=10,fig.height=5,echo=FALSE}
...
- all splines - `smooth.spline` with 6 coefficients (= 4 knots), `ns()` with 4 or 6 coefficients (`spline.df` = 3 or 5) all give approximately equal MSEs (so no need to re-do anything?)
...
- splines really do better than SIR at fitting!
