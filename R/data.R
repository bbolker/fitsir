...
##' @usage data(harbin)
##' @format A data frame with two elements
##' @references Dietz, K. 2009. "Epidemics: the fitting of the first dynamic models to data". Journal of Contemporary Mathematical Analysis (Armenian Academy of Sciences), 44(2), 97-104.
NULL
